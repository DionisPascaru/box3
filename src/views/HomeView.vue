<template>
  <div>
    ...
    <div class="intro" v-if="introAvailable">
...
import WhiteSocialMediaComponent from "@/components/main/WhiteSocialMediaComponent.vue";
...
export default {
  ...
  data() {
    return {
      introAvailable: true,
      defaultOptions: { animationData: intro, loop: true }
    }
  },
  mounted() {
    setTimeout(() => {
